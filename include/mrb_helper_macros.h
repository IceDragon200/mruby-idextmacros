...
#define base_DEF_ATTR_GET_sbyte(_mrb_name_, _mrb_type_, _type_, _name_) \
base_DEF_ATTR_GET_HEAD(_mrb_name_, _mrb_type_, _type_); \
	return mrb_fixnum_value((mrb_int)_d_->_name_); \
}

#define base_DEF_ATTR_GET_ubyte(_mrb_name_, _mrb_type_, _type_, _name_) \
base_DEF_ATTR_GET_HEAD(_mrb_name_, _mrb_type_, _type_); \
	return mrb_fixnum_value((mrb_int)_d_->_name_); \
}

#define base_DEF_ATTR_GET_ushort(_mrb_name_, _mrb_type_, _type_, _name_) \
base_DEF_ATTR_GET_HEAD(_mrb_name_, _mrb_type_, _type_); \
	return mrb_fixnum_value((mrb_int)_d_->_name_); \
}

#define base_DEF_ATTR_GET_sshort(_mrb_name_, _mrb_type_, _type_, _name_) \
base_DEF_ATTR_GET_HEAD(_mrb_name_, _mrb_type_, _type_); \
	return mrb_fixnum_value((mrb_int)_d_->_name_); \
}
...
base_DEF_ATTR_GET_HEAD(_mrb_name_, _mrb_type_, _type_); \
	return mrb_float_value(mrb, (mrb_float)_d_->_name_); \
}

#define base_DEF_ATTR_GET_double(_mrb_name_, _mrb_type_, _type_, _name_) \
base_DEF_ATTR_GET_HEAD(_mrb_name_, _mrb_type_, _type_); \
	return mrb_float_value(mrb, (mrb_float)_d_->_name_); \
}
...
#define base_DEF_ATTR_SET_ubyte(_mrb_name_, _mrb_type_, _type_, _name_) \
base_DEF_ATTR_SET_HEAD(_mrb_name_, _mrb_type_, _type_, _name_, "i", mrb_int); \
	_d_->_name_ = extmrb_clamp_ubyte(_p0_); \
	return self; \
}
